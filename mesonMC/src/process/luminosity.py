...
def Lumi(cross_sec,xbinwidth,qbinwidth,tbinwidth,xLbinwidth):
    ...
    #lumi = [(1)/((s)*(qbinwidth)*(xbinwidth)*(tbinwidth)*(xLbinwidth)) for s in sig_all]
    #print("---------------------------------\n")
    # print("\nLuminosity: ", lumi)

    nevt = [100/(l*1e-7) for l in lumi] # The 1e-6 converts properly, integrated luminosiy: 100 fb^-1
